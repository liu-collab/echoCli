...
const createCommands = () => {
  ...
  program
    .command("addcpn <name>")
    .description(
      "create cpn into a folder for example:echoCli addcpn CpnName -d src/components"
    )
    .action((name) => {
  ...
  program
    ...
    .description(
      "create cpn and router into a folder for example:echoCli addpage name -d src/views"
    )
    .action((name) => {
      addCpnAndRouterAction(
        name,
